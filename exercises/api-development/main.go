...
/**
This project has 2 files, main.go and model.go
that have incomplete code, which students need to complete.


Complete the main.go and model.go files such that
go test gives no error.


Note: You can use go mod tidy to download all
dependencies in your code, that are specified
in the go.mod file.
*/
